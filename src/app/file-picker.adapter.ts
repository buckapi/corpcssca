  ...
  public uploadFile(fileItem: FilePreviewModel) {
    ...
    .pipe(
      map( (res: HttpEvent<any>) => {
         ...
         this._uw.images.push('https://www.buckapi.com:3131/imgApi/server/local-storage/corpcssca/'+this._uw.file[0].name);
    ...
    const removeApi = 'https://db.buckapi.com/imgApi/containers/corpcssca/upload';
